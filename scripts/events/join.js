...
let gifPath = __dirname + '/Nayan/join/doha.gif';

axios.get(gifUrl, { responseType: 'arraybuffer' })
.then(response => {
    fs.writeFileSync(gifPath, response.data);
    return api.sendMessage("চলে এসেছি আমি পিচ্চি দ্দোহা তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
https://www.facebook.com/DohaVau

🔵WHATSAPP NUMBER: wa.me/+1 (321) 247-8423

🟢SUPPORT EMAIL: mddoha5657@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
